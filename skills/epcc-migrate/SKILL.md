...
| 파일 | 처리 |
| --- | --- |
| `task-workflow.md` · `task-workflow-detail.md` | → 검증 강도는 `reversibility.md`로, **Phase 라우팅(P0~P6)은 `.claude/rules/workflow-routing.md`(상시 카드)로** 이관. S/M/L 규모 판단만 폐기 |
...
2. **P0~P6 Phase 테이블은 유지**하되, 설치된 `.claude/rules/workflow-routing.md`의 Phase 표와
