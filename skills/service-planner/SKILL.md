...
description: 서비스 구조를 설계하고 구체적인 기능 요구사항을 도출합니다. 사용자가 "서비스 기획", "기능 요구사항", "화면 설계", "사용자 플로우", "기능 목록", "요구사항 도출"을 요청할 때 사용합니다. CLAUDE.md 작업 라우팅의 P0-D — 화면·사용자 플로우가 미확정인 신규 기능에서 발동합니다.
---
