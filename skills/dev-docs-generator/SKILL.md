...
IMPORTANT: tasks.md에 반드시 **수정 범위 (Scope)** 섹션을 포함해야 합니다. 이 섹션은 P4 구현 시 도메인 경계 준수를 위한 가이드입니다. `.claude/rules/modification-guardrails.md` 참조.
...
- 템플릿: `dev/templates/` (3-file 구조·섹션 규약의 권위자)
- 운영 원칙·재개 절차·Handoff 매체: `.claude/rules/task-workflow-detail.md` §Dev Docs 3-File 패턴
- 기존 활성 작업: `dev/active/`
