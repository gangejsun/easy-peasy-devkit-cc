...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    """
    Persist design system to <output_dir>/<project>/ folder using Master + Overrides pattern.
    ...
    design_system_dir = base_dir / project_slug
...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append("")
    lines.append("> **LOGIC:** When building a specific page, first check `dev/docs/design/<project>/pages/[page-name].md`.")
