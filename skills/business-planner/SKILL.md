...
description: 아이디어나 기능을 사업적 관점에서 검증하고 사업 기획서를 생성합니다. 사용자가 "사업 기획", "비즈니스 모델", "수익화", "시장 진입", "사업성 분석"을 요청할 때 사용합니다. CLAUDE.md 작업 라우팅의 P0-C — 수익 모델·시장 진입 판단이 필요한 신규 기능에서 발동합니다.
---
