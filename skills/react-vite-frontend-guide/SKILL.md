...
<!-- TODO: react-vite 프리셋 전용 프론트엔드 가이드를 작성하세요. -->
<!-- nextjs-supabase 프리셋의 frontend-dev-guidelines를 참고하되, -->
<!-- React Router, Vite, client-side rendering에 맞게 수정하세요. -->

이 파일은 react-vite 프리셋의 placeholder입니다.
프로젝트에 맞게 커스터마이즈하거나, nextjs-supabase 프리셋의 가이드를 참조하여 작성하세요.
