---
name: council-review
description: 되돌림 비용이 큰 기획 결정(사업 방향·아키텍처 선택)에서 기술/비즈니스/UX 3개 관점을 병렬 분석해 통합 권고안을 냅니다. "다관점 분석", "council review", "3관점 검토"에 사용합니다.
---
...
> **경계** — 여기의 3관점은 아직 쓰지 않은 **기획 결정**을 본다. 이미 쓰인 코드의 diff를
> correctness·security·reversibility 3렌즈로 보는 것은 `epcc-reviewer`의 Irreversible 팬아웃이다.
